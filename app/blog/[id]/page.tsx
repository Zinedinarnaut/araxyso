                    ...
                    <main className="xl:w-2/3">
                        ...
                        <div className="prose prose-invert prose-purple max-w-none mb-12">
                            ...
                            {contentParagraphs.map((paragraph, index) => {
                                if (paragraph.startsWith("#")) {
                                    ...
                                    return (
                                        <HeadingTag
                                            ...
                                            className="text-purple-200 mt-8 mb-4"
                                        >
                                            {text}
                                        </HeadingTag>
                                    )
                                ...
                                return (
                                    <p key={index} className="mb-6 text-purple-200/80 leading-relaxed">
                                        {paragraph}
                                    </p>
                                )
                            })}

                            {post.contentImages.map((img, imgIndex) => (
                    ...
                    <aside className="xl:w-1/3">
                        <div className="sticky top-4 space-y-8">
                            <div className="bg-purple-900/10 border border-purple-500/20 rounded-lg p-6">
                                <h2 className="text-xl font-semibold text-purple-200 mb-4">More from Araxyso</h2>
                            ...
                            <div className="bg-purple-900/10 border border-purple-500/20 rounded-lg p-6">
                                <h2 className="text-xl font-semibold text-purple-200 mb-4">Join Our Community</h2>
                                ...
                                <Link
                                    href="#"
                                    className="inline-flex items-center gap-2 bg-purple-500/20 text-purple-200 py-2 px-4 rounded-md hover:bg-purple-500/30 transition-colors"
                                >
